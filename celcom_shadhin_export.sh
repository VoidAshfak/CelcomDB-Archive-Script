...
/storagedata/mssql/data/dbbackup/tbl_RobiDCBRenewalCharge_archive_rows.bcp \
/storagedata/mssql/data/dbbackup/tbl_RobiDCBRenewalChargeProcess_archive_rows.bcp \
